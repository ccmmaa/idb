								...
								<div className="lead">
									<center>
										<ul id="tools">
											...
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>Slack</h3></a><p>Team communication and collaboration application</p></div><img src="http://blogs.newschool.edu/digitalhumanities/files/2016/02/Slack_Icon.png" /></li>
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>Doodle</h3></a><p>Tool to help with scheduling around classes</p></div><img src="https://cdn2.doodle.com/dist/i/7479b568749fca315a2969e30cbee4f5.png" /></li>
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>React</h3></a><p>Dynamic Frontend</p></div><img src="https://cdn-images-1.medium.com/max/1600/1*g6s1lvpfArJGorALkKNhvw.png" /></li>
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>Selenium</h3></a><p>Web applications testing</p></div><img src="https://www.seleniumhq.org/images/big-logo.png" /></li>
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>MySQL</h3></a><p>Database to store scraped data</p></div><img src="https://pbs.twimg.com/profile_images/1240079072/logo-mysql-170x170_400x400.png" /></li>
											<li className="card-shadows about-cards"><div><a href="" target="_blank"><h3>Postman</h3></a><p>Application to document and test API</p></div><img src="https://i1.wp.com/thecuriousdev.org/wp-content/uploads/2017/12/gI_62552_200x200_360-logo.png?fit=201%2C201&ssl=1" /></li>
